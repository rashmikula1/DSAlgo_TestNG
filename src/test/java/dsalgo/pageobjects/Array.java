...
public class Array extends BaseClass{
	...
	/*	public void ArrayPhython() throws InterruptedException
	{

		Action.click(driver, driver.findElement(arrayphython));
	...
	{
		driver.findElement(applicationArray).click();
	}*/
	...
	public void practiceQSearchArray() throws IOException
	{
		...
		driver.findElement(searcharray).click();
			...
			String[][] code= ExcelReader.InputData();
